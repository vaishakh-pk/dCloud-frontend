                        ...
                        <div>
                            <button className={styles.longbutton} onClick={() => {
                                ...
                                <div className={styles['longbutton-elements']}>
                                    ...
                                    <div className={styles['longbutton-filename']}>TEST_FILE</div>
                                    <div className={styles['longbutton-fileformat']}>jpeg</div>
                                    <div className={styles['longbutton-fileformat']}>1.28MB</div>
